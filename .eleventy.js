...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy("sitemap-products.xml");
  eleventyConfig.addPassthroughCopy("sitemap-locations.xml");
  eleventyConfig.addPassthroughCopy("sitemap-static.xml");
