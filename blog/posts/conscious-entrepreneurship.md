...
This podcast episode is an experiment—maybe the first of many, maybe the only one—but at its core, it's an open invitation to connect. To build something deeper than just another business conversation.

## What We Cover in This Episode

- **Conscious Entrepreneurship** – What does it mean to build something meaningful while staying true to yourself?
...
At Joe, we started with the simple idea that small businesses should have the same convenience and tech advantages as corporate giants. But stepping into the venture capital world, I quickly realized that the system isn't always set up to reward *doing the right thing*.

I found myself caught in that current, measuring our success in terms of funding rounds and milestones, making decisions out of *fear*. And that fear started to *own* me.

Then my dad passed.

And in one of the last moments I had with him, I was so consumed by stress that I didn't even fully *see* him. That realization hit me hard.
...
Business doesn't have to be a zero-sum game. It can be about *creating more value*—for everyone.

## An Open Invitation

If any of this resonates with you—if you're an entrepreneur, a creator, an investor, or just someone searching for a different way to do things—I'd love to connect.
